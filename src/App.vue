  ...
  <div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
    <div class="container">
      ...
      <section class="relative" v-if="sel">
        ...
        <button type="button" class="absolute top-0 right-0" @click="sel = ''">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            version="1.1"
            width="30"
...
export default {
  ...
  methods: {
    ...
    findCoin(inputCoin) {
      // const newCoins = Array.from(this.allCoins);
      console.log(this.allCoins[0][67].FullName);
      const resultFilter = this.allCoins[0].find(coin =>
        coin.FullName === inputCoin
      );
      console.log(resultFilter);
      // this.allCoins.push(resultFilter);
    },
    normalizeGraph() {
  ...
  async mounted() {
    ...
    const coins = await Object.values(data.Data)
    await this.allCoins.push(coins);
  }
};
</script>
